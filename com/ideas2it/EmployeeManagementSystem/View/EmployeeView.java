...
public class EmployeeView {
    ...
    EmployeeController controllerObj = new Controller();
   ...
   public void EmployeeOptions() {
    ...
    private void createEmployee() {
        ...
        boolean checkEmployeeIDStatus = controllerObj.checkEmployeeID(employeeID);
        if (checkEmployeeIDStatus == false) {                     
            ...
            controllerObj.createEmployee(employeeID, name, designation, employeeSalary, date, mobileNumber);   
