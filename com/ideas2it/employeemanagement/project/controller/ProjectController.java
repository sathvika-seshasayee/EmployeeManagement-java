...
public class ProjectController {
    ...
    public boolean checkProjectId(int projectId, boolean isDeleted) {
        return serviceObj.checkProjectId(projectId, isDeleted);
    }

    public boolean unAssignEmployees(List<Integer> employeeIds, int projectId) {
        return serviceObj.unAssignEmployees(employeeIds, projectId);
    }    

    /**
     * Passes Id of project to service layer to get set of employees
     * @param projectId id of project
     * @return list of employee details.
     */
    public String displaySetOfEmployees(int projectId) {
        return serviceObj.getSetOfEmployees(projectId);
    }

    /**
     * Passes Id of employee to service layer to check if id
     * is present in database.
     ...
     */
    public List<String> displayAllProjects(boolean isDeleted) {
        return serviceObj.getAllProjects(isDeleted);
    }

    /**
     * This method passes project id to service layer
     * @return true if project was restored
     */
